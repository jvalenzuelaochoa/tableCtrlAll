package project.benchmark.generated;
...
import project.benchmark.generated.MyBenchmark_jmhType;
public final class MyBenchmark_testMethod_jmhTest {
    ...
    MyBenchmark_jmhType _jmh_tryInit_f_mybenchmark0_G(InfraControl control) throws Throwable {
        ...
        synchronized(this.getClass()) {
            ...
            Field f;
            f = project.benchmark.MyBenchmark.class.getDeclaredField("tableName");
            f.setAccessible(true);
            f.set(val, control.getParam("tableName"));
            val.loadTime();
            val.readyTrial = true;
